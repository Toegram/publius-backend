...
tony = User.create(name: "Tony", password: 'michael', age: 30, country: "USA")
danielle = User.create(name: "Danielle", password: 'michael', age: 31, country: "Canada")
jared = User.create(name: "Jared", password: 'michael', age: 31, country: "Mexico")
claudia = User.create(name: "Claudia", password: 'michael', age: 32, country: "France")
sean = User.create(name: "Sean", password: 'michael',  age: 25, country: "Arizona")
giles = User.create(name: "Giles", password: 'michael', age: 24, country: "England")
